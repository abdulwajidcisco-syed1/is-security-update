...
| P14 | In progress (1/7) | The 2026-09-20 scheduled edition completed and all destinations reconciled. Coverage was partial due to a CISA feed failure; NVD and Hacker News succeeded, the no-news policy applied, and human review remains. Daily 03:00 UTC runs and the 09:00 Asia/Calcutta monitor remain active. |

...
| P14 | In progress (1/7) | The 2026-09-20 scheduled edition completed and all destinations reconciled. The CISA advisory RSS returned HTTP 403 on the hosted runner; commit `9373db5` switched collection to CISA's official KEV mirror, and fixed-window run [35497501506](https://github.com/abdulwajidcisco-syed1/is-security-update/actions/runs/35497501506) verified CISA KEV, NVD, and Hacker News all succeed. The no-news policy applied, and human review remains. Daily 03:00 UTC runs and the 09:00 Asia/Calcutta monitor remain active. |

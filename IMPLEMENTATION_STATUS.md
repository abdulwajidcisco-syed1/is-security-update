...
| P12 | In progress | Unified manual/daily workflow, fixed UTC window, schedule gate, scoped permissions, checkpoint restore, concurrency, 90-minute budget, three-destination publication and verification are implemented; live integrated rerun is pending. |

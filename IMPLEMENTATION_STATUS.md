...
| P06 | Done | Live RSS, NVD and Hacker News adapters, bounded retrying fetches, fixed windows, timestamp validation, relevance ranking, partial/all-failure reporting, canonical URL and cross-source content deduplication with retained evidence pass AT01–AT02. Vendor feed limitations are recorded in P03. |

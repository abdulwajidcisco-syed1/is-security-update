...
|---|---|---|---|---|---|
| CISA Known Exploited Vulnerabilities | `https://raw.githubusercontent.com/cisagov/kev-data/develop/known_exploited_vulnerabilities.json` | Official `cisagov/kev-data` public JSON mirror | Verified live 2026-09-20 | KEV `dateAdded` at 00:00 UTC | High-confidence exploited-vulnerability coverage. CISA documents that this mirror follows the canonical catalog within minutes. It replaces the advisory RSS endpoint because CISA returned HTTP 403 to GitHub-hosted runners. A source failure remains isolated and produces partial-coverage status. |

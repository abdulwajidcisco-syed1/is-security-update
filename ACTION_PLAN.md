...
| P08 | Integrate Kokoro and FFmpeg; generate sentence-level captions from actual narration chunks, enforce a 30-minute scheduled-video floor, preserve citations, and validate audio/video artifacts. | Implementer | P07 | AT07 passes; benchmark a 4,000–5,500-word, minimum-30-minute sample on the intended CPU runner. | 1–2 days |
